...
from models import Todo, UserModels
from schemas import (
    MessageSchemas,
    TodoList,
    TodoPublicSchemas,
...
@router.post('/', response_model=TodoPublicSchemas)
def create_todo(
    todo: TodoSchemas,
    user: CurrentUser,
    session: Session,
...
@router.patch('/{todo_id}', response_model=TodoPublicSchemas)
...
@router.delete('/{todo_id}', response_model=MessageSchemas)
